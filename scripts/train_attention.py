...
def main():
	...
	train_again = False
	encoder_save = '{}_att_{}bs_{}hs_{}_enc_{}_layer'.format(rnn_type, bs, enc_hidden, parser.optimizer, enc_layers)
	decoder_save = '{}_att_{}bs_{}hs_{}_dec_{}_layer'.format(rnn_type, bs, enc_hidden, parser.optimizer, dec_layers)
