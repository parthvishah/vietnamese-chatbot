...
def main():
	...
	_, _, fig = utils.get_binned_bl_score(encoder = encoder_w_att, decoder = decoder_w_att, val_dataset = ransformed_dataset['validate'], attn_flag = attn_flag, beam_size = beam_size, location = plots_dir, collate = collate_fn_dict['validate'])
