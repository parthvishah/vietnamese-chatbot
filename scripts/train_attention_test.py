...
def main():
	...
	# seq2seq model
	nmt_encoderattn = nnet_models_new.seq2seq(encoder_transformer, decoder_encoderattn, lr = lr, hiddensize = hidden_size, numlayers = hidden_size, target_lang=dataset_dict['train'].target_lang_obj, longest_label = longest_label, clip = gradient_clip, device = device)
